...
export const featuresData: Feature[] = [
  ...
  },
  {
    ...
    longDescription: 'Jumpstart your messaging with our extensive template library. Choose from 100+ professionally designed templates for various use cases, or create and save your own. Ensure brand consistency, improve response rates, and save time with reusable message components.',
    icon: 'LayoutTemplate',
    color: '#128c7e',
    benefits: [
    ...
    seo: {
      ...
      description: 'Access 100+ pre-designed WhatsApp message templates. Create, save, and reuse templates for marketing, support, and notifications.',
      keywords: [
        'whatsapp templates',
        'message templates',
        'template library',
  ...
  },
  {
    ...
    longDescription: 'Get complete visibility into your WhatsApp communication with our comprehensive analytics dashboard. Track message delivery, read rates, engagement metrics, and campaign performance in real-time. Use insights to optimize your messaging strategy and improve ROI.',
    icon: 'BarChart3',
    color: '#075e54',
    benefits: [
    ...
    seo: {
      ...
      description: 'Monitor WhatsApp message delivery, opens, and engagement with real-time analytics. Get insights to optimize your messaging strategy and improve results.',
      keywords: [
        'whatsapp analytics',
        'analytics dashboard',
        'message tracking',
