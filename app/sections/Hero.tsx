          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative">
                ...
                {/* Floating Stats Card */}
                <div className="absolute -bottom-4 left-2 md:-bottom-6 md:-left-6 bg-white rounded-xl shadow-xl p-3 md:p-4 border border-gray-100 animate-float">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg gradient-bg flex items-center justify-center">
                      <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-white" />
                    </div>
                    <div>
                      <p className="text-xl md:text-2xl font-bold text-gray-900">98.5%</p>
                ...
                <div className="absolute -top-3 -right-2 md:-top-4 md:-right-4 bg-white rounded-xl shadow-xl p-3 md:p-4 border border-gray-100 animate-float-slow animation-delay-300">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-whatsapp-light flex items-center justify-center">
                      <Sparkles className="w-4 h-4 md:w-5 md:h-5 text-whatsapp-green" />
                    </div>
                    <div>
                      <p className="text-xl md:text-2xl font-bold text-gray-900">30K+</p>
