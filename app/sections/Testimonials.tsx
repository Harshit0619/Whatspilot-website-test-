...
const testimonials = [
  ...
  },
  {
    ...
    content:
      "WhatsPilot is so much helpful and we use it daily for our products marketing and sending details. Thanks to the entire team who made this amazing app. It has completely transformed how we communicate with our customers.",
    rating: 5,
  },
  {
    id: 3,
    ...
    content:
      "One of the best and easiest UI in the industry. Very fast and unlimited messages. The automation features have saved me countless hours. Highly recommended for any digital marketer looking to scale their outreach.",
    rating: 5,
  },
  {
    id: 4,
    ...
    content:
      "In the fast-paced world of small business, efficiency and effectiveness in communication can be the key to success. WhatsPilot is an invaluable tool that caters specifically to the needs of small businesses. The ROI we have seen since implementing WhatsPilot has been incredible.",
    rating: 5,
  },
];
    ...
    >
      ...
      <div className="relative z-10 section-padding">
        <div className="container-wide">
          ...
          {/* Stats */}
          <div
            className={`grid grid-cols-2 lg:grid-cols-4 gap-6 mt-16 transition-all duration-700 delay-300 ${
              isInView
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-12"
            }`}
